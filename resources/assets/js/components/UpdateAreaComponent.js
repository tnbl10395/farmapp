...
export class UpdateAreaComponent extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            deviceId: this.props.object.object.id,
            name: this.props.object.object.name,
            ...
            <div>
                {
                    this.props.messageSuccess ?
                        <div className="alert alert-success alert-dismissible fade in">
                            ...
                            <strong>Success!</strong> The new area has just updated!
                            </div>
                        : null
                }
                {
                    ...
                    <div className="col-md-12">
                        ...
                        <div className="form-group col-md-6">
                            ...
                            <select className="form-control" onChange={(device) => this.onSelectDevice(device)}>
                                <option value={null} disabled={this.props.object.object.plantId == null ? '' : 'disabled'}>Choose later</option>
                                {
